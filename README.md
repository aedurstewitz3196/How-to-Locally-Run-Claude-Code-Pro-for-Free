...
-Install Ollama from Ollama.com or Downloads folder<br>
-When added to system path run "Ollama --version" in Windows Powershell to confirm install is completed and working<br>

<h4>2. Install Claude CLI</h4>
-Paste this command into Windows Powershell: "irm https://claude.ai/install.ps1 | iex"<br>
-Fix Path (Crucial): If Claude is not recognized, the installer likely put it in an hidden folder. Add it to your path.<br>
<ul>
